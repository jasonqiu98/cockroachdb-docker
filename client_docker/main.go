/*
  Based on https://www.cockroachlabs.com/docs/stable/build-a-go-app-with-cockroachdb.html?filters=local
*/
...
func main() {
	connStr := "postgresql://root@roach1:26257/bank?sslmode=disable"
	// can also be either of the two as well (for the other two DB nodes)
	// connStr := "postgresql://root@roach2:26257/bank?sslmode=disable"
	// connStr := "postgresql://root@roach3:26257/bank?sslmode=disable"
	...
	log.Println("Successfully connected to database \"bank\".")
